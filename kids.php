    ...
    <hr class="navbar-divider">
 	...
 	<footer class="section-p1">
 		...
 		<div class="col install">
 			...
 			<div class="row">
 				<img class="logos" src="images/apse.jpg" alt="">
