...
<head>
 ...
 <body>
    ...
    <hr class="navbar-divider">
 	...
 	<div class="pro"onclick="window.location.href='women.php';">
 		<li><a class="active" href="women.php">Womens</a></li>
 	</div>
 	<div class="pro"onclick="window.location.href='kids.php';">
 		<a href="#">Kids</i></a>
 	</div>
 	</section>
